...
เลข 136 และ 137 ถูกใช้ไปกับงานที่ดำเนินการแล้ว โดย 136 ซ่อม test guard ของ CadQuery ที่เป็น optional พร้อมอัปเดตเอกสารสถานะ และ 137 เขียนการ์ด Work 138 ด้านล่าง ส่วนบันทึกของ Work 135 เรียกงานรันฟิสิกส์ต่อบน native solids ว่า "Work 136" งานนั้นจะใช้เลขถัดไปที่ยังว่างตอนลงมือ Work 138 เป็นส่วนขยายเชิงแก้ไข เพราะ evaluator ที่ bounded campaign ใช้อ่านตัวแปรสเกล 5 ตัวแทนที่จะอ่าน geometry รูปทรงนอก template จึงให้คะแนนไม่ได้ ส่วน Work 139 เปิด grammar รูปทรงอิสระให้ candidate ของรถ มีสเปกและดำเนินการแล้ว ขณะที่ Work 140 คือการป้อนผล evaluator เข้าสู่เวลาแข่ง ถูกระบุชื่อไว้แต่ยังไม่ได้เขียนสเปก
