...
Status: Completed — coupled Level-0 implementation queue
...
| 024 | Completed | Aerodynamic force/cooling to chassis force-moment and normal-load coupling | Aero forces/moments alter shared chassis/contact loads with closed force/moment residuals and unsupported map queries invalidate the step |
| 025 | Completed | Per-contact tyre, suspension, mechanical braking, and regeneration coupling | Arbitrary contact sets share normal loads, combined tyre capacity, travel, brake torque/heat, and central recovery requests without hidden redistribution |
...
| 030 | Completed | Integration falsification, numerical refinement, cross-model promotion gate, and release review | Deliberate coupling defects fail; convergence/uncertainty evidence is recorded; unsupported candidates cannot be promoted or called discovered |
